...
<div class="api-groups">
  ...
  <div class="api-group">
    ...
    <ul>
      ...
      <li><a href="/en-US/api/add-target">grekt add-target</a><span class="desc">Add AI targets</span></li>
      <li><a href="/en-US/api/remove-target">grekt remove-target</a><span class="desc">Remove AI targets</span></li>
  ...
  <div class="api-group">
    ...
    <ul>
      ...
      <li><a href="/en-US/api/changelog">grekt changelog</a><span class="desc">Generate changesets from git history</span></li>
    </ul>
  </div>
...
grekt changelog                  # Generate changesets (interactive)
grekt changelog --ci             # Generate changesets (CI mode)
